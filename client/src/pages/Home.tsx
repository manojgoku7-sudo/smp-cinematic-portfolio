        ...
        <div className="container flex h-[5rem] items-center justify-between">
          <div className="flex items-center gap-5">
            <button className="monogram-trigger flex items-center gap-3 text-left" onClick={() => { triggerMonogramRipple(); scrollToSection("top"); }} aria-label="Go to the top and reveal the MJ monogram" aria-describedby="mj-brand-tooltip">
              <span className="monogram-aura-wrap"><span className="monogram-aura" aria-hidden="true" /><span className={`seal-wrap ${monogramRipple ? "is-rippling" : ""}`}><span className="monogram-halo" aria-hidden="true"><i className="monogram-halo-sweep" /><b className="monogram-orbit-spark" /></span><span className="monogram-click-ripple" aria-hidden="true" /><img src="/manus-storage/smp-mj-monogram-clear-j_24fbf37a.png" alt="MJ monogram" /></span></span>
