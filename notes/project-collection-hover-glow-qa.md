...
The active-card glow was calibrated upward by a controlled step: the exterior halo is now 2.05rem at 48% violet opacity, supported by a brighter outline and a 1.7rem low-opacity inner edge. The visual hover check retained the approved fan arrangement and left title content unchanged.
